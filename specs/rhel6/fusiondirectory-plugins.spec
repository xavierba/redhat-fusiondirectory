...
%package sinaps
Group:          Applications/System
Summary:        SINAPS plugin for FusionDirectory
Requires:       fusiondirectory >= %{version}, fusiondirectory-plugin-personal >= %{version}, fusiondirectory-plugin-supann >= %{version}, fusiondirectory-plugin-supann-ext >= %{version}

%description sinaps
SINAPS plugin for FusionDirectory
The integrated solution for managing reference and orchestration data business processes
FusionDirectory is a combination of system-administrator and end-user web
...
%package sinaps-schema
Group:          Applications/System
Summary:        LDAP schema for FusionDirectory SINAPS plugin
Requires:       fusiondirectory-schema >= %{version}, fusiondirectory-plugin-personal-schema >= %{version}, fusiondirectory-plugin-supann-schema >= %{version}, fusiondirectory-plugin-supann-ext-schema >= %{version}

%description sinaps-schema
LDAP schema for FusionDirectory SINAPS plugin
This package includes the LDAP schemas needed by the FusionDirectory SINAPS plugin.
FusionDirectory is a combination of system-administrator and end-user web
interface, designed to handle LDAP based network infrastructures.
...
%files sinaps
%defattr(0644,root,root,755)
%doc %attr (-,root,root)     %{_datadir}/doc/fusiondirectory-plugin-sinaps/AUTHORS.md
%doc %attr (-,root,root)     %{_datadir}/doc/fusiondirectory-plugin-sinaps/LICENSE
%doc %attr (-,root,root)     %{_datadir}/doc/fusiondirectory-plugin-sinaps/Changelog
%attr (-,root,root)     %{_datadir}/fusiondirectory/html/sinaps.php
%attr (-,root,root)     %{_datadir}/fusiondirectory/include/class_sinapsDiffusionHandlerJob.inc
%attr (-,root,root)     %{_datadir}/fusiondirectory/include/class_sinapsRequest.inc
%attr (-,root,root)     %{_datadir}/fusiondirectory/include/class_sinapsRequestAcquisition.inc
%attr (-,root,root)     %{_datadir}/fusiondirectory/locale/plugins/sinaps/
%attr (-,root,root)     %{_datadir}/fusiondirectory/plugins/config/sinaps/
%attr (-,root,root)     %{_datadir}/fusiondirectory/plugins/personal/sinaps/
