...
%attr (-,root,root)     %{_datadir}/fusiondirectory/html/themes/breezy/icons/16/apps/ldap.png
...
%attr (-,root,root)     %{_datadir}/fusiondirectory/html/themes/legacy/icons/16/apps/ldap.png
