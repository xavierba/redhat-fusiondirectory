...
%package spamassasins
Group:          Applications/System
Summary:        Management plugin for spamassasins
Requires:       fusiondirectory >= %{version}

%description spamassasins
Management plugin for spamassasins
...
%package spamassasins-schema
Group:          Applications/System
Summary:        LDAP schema for FusionDirectory spamassasins plugin

%description spamassasins-schema
LDAP schema for FusionDirectory spamassasins plugin
...
%attr (-,root,root)     %{_datadir}/fusiondirectory/locale/plugins/spamassasins/locale/
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasins/AUTHORS
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasins/COPYING
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasins/Changelog
...
%files spamassasins-schema
%attr (-,root,root)     %{_sysconfdir}/openldap/schema/fusiondirectory/spamassasins-fd.schema
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasins-schema/AUTHORS
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasins-schema/COPYING
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasins-schema/Changelog
