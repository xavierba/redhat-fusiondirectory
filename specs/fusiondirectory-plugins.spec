...
%package spamassasin
Group:          Applications/System
Summary:        Management plugin for spamassasin
Requires:       fusiondirectory >= %{version}

%description spamassasin
Management plugin for spamassasin
...
%package spamassasin-schema
Group:          Applications/System
Summary:        LDAP schema for FusionDirectory spamassasin plugin

%description spamassasin-schema
LDAP schema for FusionDirectory spamassasin plugin
...
%attr (-,root,root)     %{_datadir}/fusiondirectory/locale/plugins/spamassasin/locale/
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasin/AUTHORS
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasin/COPYING
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasin/Changelog
...
%files spamassasin-schema
%attr (-,root,root)     %{_sysconfdir}/openldap/schema/fusiondirectory/spamassasin-fd.schema
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasin-schema/AUTHORS
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasin-schema/COPYING
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassasin-schema/Changelog
