...
%package spamassassins
Group:          Applications/System
Summary:        Management plugin for spamassassins
Requires:       fusiondirectory >= %{version}

%description spamassassins
Management plugin for spamassassins
...
%package spamassassins-schema
Group:          Applications/System
Summary:        LDAP schema for FusionDirectory spamassassins plugin

%description spamassassins-schema
LDAP schema for FusionDirectory spamassassins plugin
...
%attr (-,root,root)     %{_datadir}/fusiondirectory/locale/plugins/spamassassins/locale/
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassassins/AUTHORS
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassassins/COPYING
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassassins/Changelog
...
%files spamassassins-schema
%attr (-,root,root)     %{_sysconfdir}/openldap/schema/fusiondirectory/spamassassins-fd.schema
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassassins-schema/AUTHORS
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassassins-schema/COPYING
%doc %attr(-,root,root)  %{_datadir}/doc/fusiondirectory-plugin-spamassassins-schema/Changelog
