...
%attr (-,root,root)	%{_datadir}/fusiondirectory/html/plugins/subcontracting/themes/default/icons/16/types/subcontracting.png
%attr (-,root,root)	%{_datadir}/fusiondirectory/html/plugins/subcontracting/themes/default/icons/48/types/subcontracting.png
