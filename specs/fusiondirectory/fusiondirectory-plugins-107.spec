...
for cur_plugin_line in ${PLUGINS_LIST} ; do
  ...
  if [ "${cur_plugin}" = "developers" ] ; then
    # Docs
    mkdir -p %{buildroot}%{_datadir}/doc/fusiondirectory-${cur_plugin}/
    cp ../../fusiondirectory-%{version}/{AUTHORS,Changelog,COPYING} %{buildroot}%{_datadir}/doc/fusiondirectory-${cur_plugin}/ 
  else
    # Docs
...
%post
%{_sbindir}/fusiondirectory-setup --yes --check-directories --update-locales --update-cache
...
%attr (-,root,root)	%{_datadir}/fusiondirectory/locale/plugins/desktop-management/locale/lv/fusiondirectory.po
...
%attr (-,root,root)	%{_datadir}/fusiondirectory/locale/plugins/desktop-management/locale/sv/fusiondirectory.po
%attr (-,root,root)	%{_datadir}/fusiondirectory/locale/plugins/desktop-management/locale/pt/fusiondirectory.po
%attr (-,root,root)	%{_datadir}/fusiondirectory/locale/plugins/desktop-management/locale/ar/fusiondirectory.po
...
%doc %attr(-,root,root) %{_datadir}/doc/fusiondirectory-developers/AUTHORS
%doc %attr(-,root,root) %{_datadir}/doc/fusiondirectory-developers/Changelog
%doc %attr(-,root,root) %{_datadir}/doc/fusiondirectory-developers/COPYING
...
%attr (-,root,root)	%{_datadir}/fusiondirectory/plugins/personal/supann/supann.tpl
...
%config(noreplace) %attr (-,root,root)	%{_sysconfdir}/openldap/schema/fusiondirectory/update-from-1.0.6-to-1.0.7/update-mail-fd.ldif
...
%config(noreplace) %attr (-,root,root)	%{_sysconfdir}/openldap/schema/fusiondirectory/update-from-1.0.6-to-1.0.7/update-service-fd.ldif
%config(noreplace) %attr (-,root,root)	%{_sysconfdir}/openldap/schema/fusiondirectory/update-from-1.0.6-to-1.0.7/update-systems-fd-conf.ldif
...
- Fixes #309: Remove the goAgent.pl from squid package 
