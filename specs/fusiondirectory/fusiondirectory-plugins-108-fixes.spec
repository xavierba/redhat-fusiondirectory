...
%package ppolicy
Group:          Applications/System
Summary:        Management plugin for ppolicy
Requires:       fusiondirectory >= %{version}
...
LDAP schema for FusionDirectory ppolcy plugin
...
%defattr(0644,root,root)
%config(noreplace) %attr (-,root,root)  %{_sysconfdir}/openldap/schema/fusiondirectory/ppolicy-fd-conf.schema
%config(noreplace) %attr (-,root,root)  %{_sysconfdir}/openldap/schema/fusiondirectory/ppolicyconfig.ldif
%config(noreplace) %attr (-,root,root)  %{_sysconfdir}/openldap/schema/fusiondirectory/ppolicydefault.ldif
%config(noreplace) %attr (-,root,root)  %{_sysconfdir}/openldap/schema/fusiondirectory/ppolicymodule.ldif
%doc %attr(-,root,root) %{_datadir}/doc/fusiondirectory-plugin-webservice-schema/AUTHORS
%doc %attr(-,root,root) %{_datadir}/doc/fusiondirectory-plugin-webservice-schema/Changelog
%doc %attr(-,root,root) %{_datadir}/doc/fusiondirectory-plugin-webservice-schema/COPYING
